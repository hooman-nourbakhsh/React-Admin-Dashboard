...
const Cart = () => {
  const { currentColor, clickHandler } = useStateContext();
    ...
    <div className="bg-half-transparent w-full fixed z-20 top-0 right-0 ">
      <div
        ...
        <div className="mt-3 mb-3">
          <div className="flex justify-between items-center">
            <p className="text-gray-500 dark:text-gray-200">جمع بدون هزینه حمل</p>
        ...
        <div className="mt-5">
          <Button color="white" bgColor={currentColor} text="نهایی کردن سفارش" borderRadius="10px" width="full" />
        </div>
      </div>
    </div>
  );
